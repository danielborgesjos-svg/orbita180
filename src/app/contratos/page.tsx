    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            ...
            contracts.map((contract) => (
              <div key={contract.id} className="card" style={{ border: '1px solid var(--border)', position: 'relative' }}>
                ...
                <div style={{ display: 'flex', gap: '0.75rem', marginTop: 'auto' }}>
                  {contract.file_url ? (
                    <a href={contract.file_url} target="_blank" rel="noopener noreferrer" style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', padding: '0.5rem', borderRadius: 'var(--radius)', border: '1px solid var(--border)', fontSize: '0.8rem', fontWeight: '600' }}>
                      <FileCheck size={14} /> Ver PDF Anexado
                    </a>
                  ) : contract.url ? (
                    ...
                    <span style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', padding: '0.5rem', borderRadius: 'var(--radius)', border: '1px solid var(--border)', fontSize: '0.8rem', fontWeight: '600', color: 'var(--muted-foreground)' }}>
                      Nenhum arquivo
                    </span>
                  )}
                </div>
      ...
      >
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            <label style={{ fontSize: '0.85rem', fontWeight: '600' }}>Link Externo (URL)</label>
            <input 
              name="url" 
              type="url"
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            <label style={{ fontSize: '0.85rem', fontWeight: '600' }}>Anexar Arquivo (PDF)</label>
            <input 
              name="file" 
              type="file"
              accept=".pdf,.doc,.docx"
