...
const StatsCard = ({ title, value, change, icon: Icon, description, color }: StatsCardProps) => {
  ...
  return (
    <div className="card premium-shadow">
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1rem' }}>
        ...
        <div style={{ padding: '0.5rem', background: 'var(--secondary)', borderRadius: '10px', color: color || 'var(--primary)' }}>
          <Icon size={20} />
        </div>
      </div>
